...
<template>
    <div>
        <h1>Dashboard</h1>
        <p>Ceci est un texte en dur pour le débogage.</p>
    </div>
</template>
...
<!--            refreshDashboardData();-->
<!--        } else {-->
<!--            router.push({ name: 'LoginAndRegister' });-->
<!--        }-->
<!--    } catch (error) {-->
...
<!--            </template>-->
<!--            <template v-slot:body>-->
<!--                &lt;!&ndash; Container to display book information and options &ndash;&gt;-->
<!--                <div class="container-infobook" v-if="bookInfo">-->
<!--                    &lt;!&ndash; Display book details &ndash;&gt;-->
...
<!--&lt;!&ndash;                    <input type="hidden" v-model="bookInfo.isbn"/>&ndash;&gt;-->
<!--&lt;!&ndash;                    <input type="hidden" v-model="bookInfo.google_books_id"/>&ndash;&gt;-->
